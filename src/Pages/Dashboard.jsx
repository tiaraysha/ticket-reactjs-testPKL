    ...
    <div className="container-fluid p-4" style={{ backgroundColor: "#f8fafc" }}>
      ...
      <div className="row">
        <div className="col-xl-8 col-lg-10 mx-auto">
          ...
          >
            ...
            <div
              className="card-footer bg-white border-0 text-end py-3"
              style={{ borderRadius: "0 0 12px 12px", fontSize: "0.85rem" }}
            >
      ...
      <div className="row mt-4 justify-content-center">
        <div className="col-xl-3 col-md-6 mb-4">
          <div
            className="card border-left-primary shadow-sm h-100 py-2"
          ...
          >
            <div className="card-body">
              <div className="d-flex align-items-center">
                <div className="me-3">
                  <i
                    className="bi bi-ticket-detailed text-primary"
